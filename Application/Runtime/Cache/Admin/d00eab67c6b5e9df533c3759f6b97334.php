...
<div class="margin clearfix">
  ...
  <tbody>
    <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
            ...
            <td> 
              <img src="/steel/Public/Uploads/<?php echo ($vo["photouri"]); ?>" alt="" width="200px;">
            </td>
            <td class="td-manage">
            <a title="修改" href="<?php echo U('Admin/Index/exitPic',array('id'=>$vo[id]));?>"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>
            </td>
