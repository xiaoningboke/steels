...
<head>
	<meta charset="UTF-8">
	<title>电子地图_<?php echo ($info["company"]); ?></title>
...
<div class="main">
	<div class="bigImgDiv">
		<img src="/steel/Public/Uploads/<?php echo ($photodata[12]["photouri"]); ?>" alt="" class="bigImg">
	</div>
	<div class="w con">
		<div class="Conright">
			<div class="leftTopTitle">地理位置</div>
			<div class="rightCon" style="padding: 20px;">
				 <div id="mapCanvas" class="map-canvas no-margin" style="height: 300px; width: 100%">
		            <script type="text/javascript">
		                var map = new BMap.Map("mapCanvas"); // 创建Map实例
		                var point = new BMap.Point("<?php echo ($info["jingdu"]); ?>", "<?php echo ($info["weidu"]); ?>"); // 创建点坐标
		                ...
		                var infoWindow = new BMap.InfoWindow("<?php echo ($info["company"]); ?><br/>联系电话：<?php echo ($info["phone"]); ?>"); // 创建信息窗口对象
