...
<head>
	<meta charset="UTF-8">
	<title>联系方式_<?php echo ($info["company"]); ?></title>
...
<link rel="stylesheet" href="/steel/Public/m/css/about.css">

<div class="main">
	<div class="bigImgDiv">
		<img src="/steel/Public/Uploads/<?php echo ($photodata[11]["photouri"]); ?>" alt="" class="bigImg">
	</div>
	...
	<div class="w con">
		...
		<div class="Conright">
			...
			<div class="rightCon">
				<div style="padding:30px;padding-top:0px;font-size: 20px;">
					<p><span style="font-weight: 700;">联系人：</span><?php echo ($info["people"]); ?></p>
					<p><span style="font-weight: 700;">QQ：</span><?php echo ($info["qq"]); ?></p>
					<p><span style="font-weight: 700;">电话：</span><?php echo ($info["phone"]); ?></p>
					<p><span style="font-weight: 700;">微信：</span><?php echo ($info["wetch"]); ?></p>
					<p><span style="font-weight: 700;">邮箱：</span><?php echo ($info["email"]); ?></p>
					<p><span style="font-weight: 700;">网址：</span><?php echo ($info["url"]); ?></p>
					<p><span style="font-weight: 700;">地址：</span><?php echo ($info["address"]); ?></p>
				</div>
			</div>
		</div>
	</div>
