...
<head>
	<meta charset="UTF-8">
	<title>下载中心_<?php echo ($info["company"]); ?></title>
		<!-- SEO -->
...
<div class="main">
	<div class="bigImgDiv">
		<img src="/steel/Public/Uploads/<?php echo ($photodata[13]["photouri"]); ?>" alt="" class="bigImg">
	</div>
	<div class="fynews">
		<div class="w">
	...
	<div class="w con">
		...
		<div class="Conright">
			<div class="leftTopTitle newsleftTopTitle">下载中心</div>
			<div class="rightCon">
				<div class="newsList">
					<ul class="news tuijian">
						<?php if(is_array($tuijian)): foreach($tuijian as $key=>$vo): ?><li><span>[推荐]</span><a href="<?php echo U('Home/Content/download',array('id'=>$vo[id]));?>"><?php echo ($vo["filename"]); ?></a><span class="newsTime"><?php echo ($vo["time"]); ?></span></li><?php endforeach; endif; ?>
					</ul>
					<ul class="news">
						<?php if(is_array($data)): foreach($data as $key=>$vo): ?><li><a href="<?php echo U('Home/Content/download',array('id'=>$vo[id]));?>"><?php echo ($vo["filename"]); ?></a><span class="newsTime"><?php echo ($vo["time"]); ?></span></li><?php endforeach; endif; ?>
