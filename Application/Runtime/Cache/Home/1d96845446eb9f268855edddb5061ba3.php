			...
			<div class="rightCon">
				<div class="newsList">
					<ul class="news tuijian">
						<?php if(is_array($tuijian)): foreach($tuijian as $key=>$vo): ?><li><a href="<?php echo U('Home/Content/disNews',array('id'=>$vo[id]));?>"><span>[推荐]</span> <?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; ?>
					</ul>
					<ul class="news">
						<?php if(is_array($list)): foreach($list as $key=>$vo): ?><li><a href="<?php echo U('Home/Content/disNews',array('id'=>$vo[id]));?>"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; ?>
					</ul>
