...
<head>
	<meta charset="UTF-8">
	<title>搜索_<?php echo ($info["company"]); ?></title>
		<!-- SEO -->
...
<div class="main">
	<div class="bigImgDiv w">
		<img src="/Public/Uploads/<?php echo ($photodata[14]["photouri"]); ?>" alt="" class="bigImg">	
	</div>
	<div class="fynews">
		<div class="w">
	...
	<div class="w con">
		...
		<div class="Conright">
			<div class="leftTopTitle newsleftTopTitle">搜索内容</div>
			<div class="rightCon">
				<div class="newsList">
					<ul class="news">
						<?php if(is_array($data)): foreach($data as $key=>$vo): ?><li><a href="<?php echo U('Home/Content/disNews',array('id'=>$vo[id]));?>"><?php echo ($vo["title"]); ?></a><span class="newsTime"><?php echo ($vo["time"]); ?></span></li><?php endforeach; endif; ?>
