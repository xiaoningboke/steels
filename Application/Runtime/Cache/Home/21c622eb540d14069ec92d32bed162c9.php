...
<div class="main">
	<div class="bigImgDiv">
		<img src="/steel/Public/Uploads/<?php echo ($data[0][photouri]); ?>" alt="" class="bigImg">
	</div>
	<div class="fynews">
		<div class="w">
	...
	<div class="w con">
		...
		<div class="Conright">
			...
			<div class="rightCon">
			<!--轮播图-->
			<div id="carousel-example-generic" class="carousel slide conlunbo" data-ride="carousel">
			  <!-- Indicators -->
			  <ol class="carousel-indicators">
			  	<?php if(is_array($picdata)): foreach($picdata as $k=>$vo): ?><li data-target="#carousel-example-generic" data-slide-to="<?php echo ($k); ?>" class="dian"></li><?php endforeach; endif; ?>
			  </ol>

			  <!-- Wrapper for slides -->
			  <div class="carousel-inner" role="listbox">
				<?php if(is_array($picdata)): foreach($picdata as $key=>$vo): ?><div class="item conPic">
				      <img class="center-block" src="/steel/Public/Uploads/<?php echo ($vo["picname"]); ?>" alt="<?php echo ($data[0][title]); ?>">
...
<script>
	window.onload=function(){
		var dom=document.getElementsByClassName("conPic")[0].classList.add("active");
		var dom=document.getElementsByClassName("dian")[0].classList.add("active");
